    ...
    return Row(
      ...
      children: [
        Row(
          ...
          children: [
            ...
            Text(
              ...
              style: TextStyle(
                  color: AppColors.brownColor, fontSize: dimensionFontSize(16)),
            ),
        ...
        Text(
          ...
          style: TextStyle(
              color: AppColors.brownColor, fontSize: dimensionFontSize(18)),
        ),
        Container(
          height: dimensionHeight(0.08),
          padding: const EdgeInsets.all(10),
          decoration: BoxDecoration(
              color: cartProvider.myCart.contains(foodInfo)
